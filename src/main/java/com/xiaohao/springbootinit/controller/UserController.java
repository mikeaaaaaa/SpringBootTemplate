...
public class UserController {
     ...
     */
    @PostMapping("/login")
    public BaseResponse<String> userLogin(@RequestBody @Valid UserLoginRequest userLoginRequest, HttpServletRequest request) {
